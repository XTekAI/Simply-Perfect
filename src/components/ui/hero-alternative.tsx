...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-stone-50 dark:bg-gray-950 pt-20">
      ...
      <main className="relative z-20 max-w-4xl mx-auto px-4 text-center">
        <div className="text-center">
          ...
          <motion.h1
            className="text-5xl md:text-7xl font-serif font-bold text-gray-900 dark:text-white mb-6 leading-tight"
          ...
          <motion.p
            className="text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto font-light leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
